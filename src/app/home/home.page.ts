...
export class HomePage {
  ...
  async initializeGoogleAuth() {
    try {
      if (this.platform.is('capacitor')) {
        ...
        await GoogleAuth.initialize({
          clientId: '793884728909-mu5dehr3158vc1e6et8ba19vua0cvg7n.apps.googleusercontent.com',
  ...
  private handleAuthResult(result: GoogleUser | Authentication) {
    if ('email' in result) {
      ...
      this.user = {
        // We don't have user details in this case
        // You might want to make an additional API call to get user details
